...
void AmbiEncoderAudioProcessorEditor::resized()
{
    ...
    sliderPanPosition->setBounds (32, 24, 150, 24);
...
<JUCER_COMPONENT documentType="Component" className="AmbiEncoderAudioProcessorEditor"
  ...
  <SLIDER name="new slider" id="98762f3308e6f9ae" memberName="sliderPanPosition"
          virtualName="" explicitFocusOrder="0" pos="32 24 150 24" min="0"
